...
class ModelSaleOrder extends Model {
	...
	public function addOrder($customer, $invoice_prefix, $shipping_firstname, $shipping_lastname, $shipping_company, $shipping_address_1, $shipping_address_2, $shipping_city, $shipping_country, $shipping_country_id, $shipping_postcode, $shipping_zone, $shipping_zone_id, $shipping_method, $shipping_code, $shipping_phone, $shipping_chinaid, $currency_code) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET invoice_prefix = '" . $this->db->escape($invoice_prefix) . "', store_id = '0', store_name = '', store_url = '', customer_id = '" . (int)$customer['customer_id'] . "', customer_group_id = '" . (int)$customer['customer_group_id'] . "', firstname = '" . $this->db->escape($customer['firstname']) . "', lastname = '" . $this->db->escape($customer['lastname']) . "', email = '" . $this->db->escape($customer['email']) . "', telephone = '" . $this->db->escape($customer['telephone']) . "', fax = '" . $this->db->escape($customer['fax']) . "', custom_field = '', payment_firstname = '', payment_lastname = '', payment_company = '', payment_address_1 = '', payment_address_2 = '', payment_city = '', payment_postcode = '', payment_country = '', payment_country_id = '', payment_zone = '', payment_zone_id = '', payment_address_format = '', payment_custom_field = '', payment_method = '', payment_code = '', shipping_firstname = '" . $this->db->escape($shipping_firstname) . "', shipping_lastname = '" . $this->db->escape($shipping_lastname) . "', shipping_company = '" . $this->db->escape($shipping_company) . "', shipping_address_1 = '" . $this->db->escape($shipping_address_1) . "', shipping_address_2 = '" . $this->db->escape($shipping_address_2) . "', shipping_city = '" . $this->db->escape($shipping_city) . "', shipping_postcode = '" . $this->db->escape($shipping_postcode) . "', shipping_country = '" . $this->db->escape($shipping_country) . "', shipping_country_id = '" . (int)$shipping_country_id . "', shipping_zone = '" . $this->db->escape($shipping_zone) . "', shipping_zone_id = '" . (int)$shipping_zone_id . "', shipping_address_format = '', shipping_custom_field = '', shipping_method = '" . $this->db->escape($shipping_method) . "', shipping_code = '" . $this->db->escape($shipping_code) . "', comment = '', total = '0.0', affiliate_id = '', commission = '0.0', marketing_id = '0', tracking = '', language_id = '1', currency_id = '0', currency_code = '" . $this->db->escape($currency_code) . "', currency_value = '0.0', ip = '" . $this->db->escape($_SERVER['REMOTE_ADDR']) . "', forwarded_ip = '', user_agent = 'import csv', accept_language = '', order_status_id='1', date_added = NOW(), date_modified = NOW()");
	...
	public function addOrderProduct($order_id, $product, $quantity) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "order_product SET order_id = '" . (int)$order_id . "', product_id = '" . (int)$product['product_id'] . "', name = '" . $this->db->escape($product['name']) . "', model = '" . $this->db->escape($product['model']) . "', quantity = '" . (int)$quantity . "', price = '" . (float)$product['price'] . "', total = '0.0', tax = '0.0', reward = '0'");
	...
	public function getOrders($data = array()) {
		$sql = "SELECT 	o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, CONCAT(o.shipping_firstname, ' ', o.shipping_lastname) AS shipping_name, 
						...
						o.order_status_id, o.invoice_prefix, o.shipping_code, o.total, o.weight, o.delivery_company, o.delivery_number, o.currency_code, o.currency_value, o.date_added, o.date_modified 
