                	...
                	<tr>
                    	<td colspan="2">
                            <div class="form-group">
                                ...
                                <input type="text" class="licenseCodeBox form-control" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" name="iwatermark[LicenseCode]" id="moduleLicense" value="<?php echo !empty($data['iwatermark']['LicenseCode']) ? $data['iwatermark']['LicenseCode'] : ''?>" />
                            </div>
