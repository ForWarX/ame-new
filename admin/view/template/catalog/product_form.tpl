          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-tax"><?php echo $entry_bao_guan; ?></label>
                <div class="col-sm-4">
                  <input type="text" placeholder="<?php echo $entry_bao_guan; ?>" id="input-bao-guan" class="form-control" readonly />
                </div>
              </div>
              <div class="form-group">
...
<script>
    // 改变报关价格
    var bao_guan_tax = <?php echo $bao_guan_tax; ?>;
    var input_price = $("#input-price");
    var bao_guan_price = parseFloat(Number(input_price.val()) * bao_guan_tax).toFixed(2);
    $("#input-bao-guan").val(bao_guan_price);
    input_price.on("change", function() {
        bao_guan_price = parseFloat(Number(input_price.val()) * bao_guan_tax).toFixed(2);
        $("#input-bao-guan").val(bao_guan_price);
    });
</script>
</div>
