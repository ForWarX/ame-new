<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <input type="hidden" name="lastname" value="Ignore" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="form-control" />
      <div class="form-group required">
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <!-- div class="form-group" style='display: none;'>
        ...
        <input type="hidden" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-payment-address-2" class="form-control" />
      <div class="form-group required">
