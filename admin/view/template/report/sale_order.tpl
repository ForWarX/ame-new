              ...
              <div class="form-group">
              	<div class='row'>
              		<form action='<?php echo $import_url; ?>' method='POST'  enctype="multipart/form-data">
	          			<span class="control-label col-sm-4"><input type='file' name='file' class=""></span>
	           			<button type="submit" id="button-import" class="btn btn-primary" data-url='report/sale_order/import'><i class="fa fa-arrow-circle-right"></i> <?php echo $button_import; ?></button>
              		</form>
              	</div>
              </div>
            </div>
            <div class="col-sm-6">
              ...
              <div class="form-group">
    	       	<div class='row'>
    	       		...
    	       		<div class='col-sm-2'>
              			<button type="button" id="button-export" class="btn btn-primary pull-right" data-url='report/sale_order/export'><i class="fa fa-arrow-circle-down"></i> <?php echo $button_export; ?></button>
                	</div>
    	       		<div class='col-sm-2'>
		              	<button type="button" id="button-filter" class="btn btn-primary pull-right" data-url='report/sale_order'><i class="fa fa-filter"></i> <?php echo $button_filter; ?></button>
	            	</div>
    	        </div>
              </div>
            </div>
...
$('#button-filter, #button-export').on('click', function() {
	url = 'index.php?route=' + $(this).attr('data-url') + '&token=<?php echo $token; ?>';
