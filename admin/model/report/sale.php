...
class ModelReportSale extends Model {
	...
	public function getExportOrders($data = array()) {
		...
		$sql .= " o.order_id,";
		// $sql .= " o.invoice_no,";
		$sql .= " o.invoice_prefix AS ame_no,";
		//$sql .= " o.store_id,";
		//$sql .= " o.storage_id,";
		$sql .= " (SELECT sto.name FROM `" . DB_PREFIX . "storage` sto WHERE o.storage_id=sto.storage_id) as storage,";
		//$sql .= " o.store_name,";
		//$sql .= " o.store_url,";
		//$sql .= " o.customer_id,";
		//$sql .= " o.customer_group_id,";
		$sql .= " o.firstname AS name,";
		// $sql .= " o.lastname,";
		$sql .= " o.email,";
		$sql .= " o.telephone,";
		//$sql .= " o.fax,";
		//$sql .= " o.custom_field,";
		$sql .= " o.payment_firstname AS payment_name,";
		//$sql .= " o.payment_lastname,";
		$sql .= " o.payment_company,";
		$sql .= " o.payment_address_1,";
		//$sql .= " o.payment_address_2,";
		$sql .= " o.payment_city,";
		$sql .= " o.payment_postcode,";
		$sql .= " o.payment_country,";
		//$sql .= " o.payment_country_id,";
		$sql .= " o.payment_zone,";
		//$sql .= " o.payment_zone_id,";
		//$sql .= " o.payment_address_format,";
		//$sql .= " o.payment_custom_field,";
		$sql .= " o.payment_method,";
		//$sql .= " o.payment_code,";
		$sql .= " o.shipping_firstname AS shipping_name,";
		//$sql .= " o.shipping_lastname,";
		$sql .= " o.shipping_company,";
		$sql .= " o.shipping_address_1,";
		//$sql .= " o.shipping_address_2,";
		$sql .= " o.shipping_city,";
		$sql .= " o.shipping_postcode,";
		$sql .= " o.shipping_country,";
		//$sql .= " o.shipping_country_id,";
		$sql .= " o.shipping_zone,";
		//$sql .= " o.shipping_zone_id,";
		//$sql .= " o.shipping_address_format,";
		//$sql .= " o.shipping_custom_field,";
		$sql .= " o.shipping_method,";
		//$sql .= " o.shipping_code,";
		$sql .= " o.comment,";
		$sql .= " o.total,";
		// $sql .= " o.order_status_id,";
		$sql .= " (SELECT s.name FROM `" . DB_PREFIX . "order_status` s WHERE o.order_status_id=s.order_status_id ORDER BY language_id ASC limit 1) AS status,";
		//$sql .= " o.affiliate_id,";
		//$sql .= " o.commission,";
		//$sql .= " o.marketing_id,";
		//$sql .= " o.tracking,";
		$sql .= " o.weight,";
		$sql .= " o.delivery_company,";
		$sql .= " o.delivery_number,";
		//$sql .= " o.language_id,";
		//$sql .= " o.currency_id,";
		//$sql .= " o.currency_code,";
		...
		$sql .= " JOIN `" . DB_PREFIX . "order_product` op ON (o.order_id=op.order_id)";
