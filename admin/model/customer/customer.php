	...
	public function editCustomer($customer_id, $data) {
		...
		if (isset($data['address'])) {
			foreach ($data['address'] as $address) {
				...
				$ext_sql = '';
				if (isset($address['chinaid'])) $ext_sql .= "chinaid = '" . $this->db->escape($address['chinaid']) . "', ";
				if (!empty($address['chinaid_front'])) $ext_sql .= "chinaid_front = '" . $this->db->escape($address['chinaid_front']) . "', ";
				if (!empty($address['chinaid_back'])) $ext_sql .= "chinaid_back = '" . $this->db->escape($address['chinaid_back']) . "', ";

                //$this->db->query("INSERT INTO " . DB_PREFIX . "address SET " . $ext_sql . "address_id = '" . (int)$address['address_id'] . "', customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($address['firstname']) . "', lastname = '" . $this->db->escape($address['lastname']) . "', company = '" . $this->db->escape($address['company']) . "', address_1 = '" . $this->db->escape($address['address_1']) . "', address_2 = '" . $this->db->escape($address['address_2']) . "', city = '" . $this->db->escape($address['city']) . "', postcode = '" . $this->db->escape($address['postcode']) . "', country_id = '" . (int)$address['country_id'] . "', zone_id = '" . (int)$address['zone_id'] . "', custom_field = '" . $this->db->escape(isset($address['custom_field']) ? json_encode($address['custom_field']) : '') . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "address SET " . $ext_sql . "address_id = '" . (int)$address['address_id'] . "', customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($address['firstname']) . "', company = '" . $this->db->escape($address['company']) . "', address_1 = '" . $this->db->escape($address['address_1']) . "', address_2 = '" . $this->db->escape($address['address_2']) . "', city = '" . $this->db->escape($address['city']) . "', postcode = '" . $this->db->escape($address['postcode']) . "', country_id = '" . (int)$address['country_id'] . "', zone_id = '" . (int)$address['zone_id'] . "', custom_field = '" . $this->db->escape(isset($address['custom_field']) ? json_encode($address['custom_field']) : '') . "'");
