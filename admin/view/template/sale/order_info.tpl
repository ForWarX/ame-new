  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $lables; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_labels_print; ?>" class="btn btn-info"><i class="fa fa-barcode"></i></a>
        ...
        <a href="<?php echo $order_copy; ?>" data-toggle="tooltip" title="<?php echo $button_order_copy; ?>" class="btn btn-primary" target="_blank"><i class="fa fa-copy"></i></a>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              <td class="text-left"><button id="button-custom-pass" class="btn btn-success btn-xs"><i class="fa fa-check"></i></button> <?php echo $column_custom_pass; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><input type='checkbox' data_id='<?php echo $product['product_id']; ?>' name='custom_pass[]' value='<?php echo $product['order_product_id']; ?>' <?php echo $product['custome_pass'] ? "checked" : ''; ?>></td>
          ...
          <div class="tab-pane active" id="tab-history">
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_storage; ?></label>
                  <div class="col-sm-10">
                    <select name="storage_id" id="input-storage" class="form-control">
                      <option value="0"><?php echo $text_select_storage; ?></option>
                      <?php foreach ($storage_list as $storage) { ?>
                      <?php if ($storage['storage_id'] == $storage_id) { ?>
                      <option value="<?php echo $storage['storage_id']; ?>" selected="selected"><?php echo $storage['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $storage['storage_id']; ?>"><?php echo $storage['name']; ?></option>
                      <?php } ?>
                      <?php } ?>
                    </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<input type="text" name="weight" value="<?php echo $weight; ?>" id="input-weight" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<input type="text" name="delivery_number" value="<?php echo $delivery_number; ?>" id="input-delivery-number" />
                  </div>
                </div>
                <div class="form-group">
...
$(document).delegate('#button-custom-pass', 'click', function() {
	
	$.ajax({
		url: 'index.php?route=sale/order/custompass&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		data: $('input[name="custom_pass[]"]').serialize(),
		beforeSend: function() {
			$('#button-custom-pass').button('loading');
		},
		complete: function() {
			$('#button-custom-pass').button('reset');
		},
		success: function(json) {
			$('.alert').remove();
