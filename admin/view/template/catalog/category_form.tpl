        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-canMix"><span data-toggle="tooltip" title="<?php echo $help_canMix; ?>"><?php echo $entry_canMix; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($canMix) { ?>
                        <input type="checkbox" name="canMix" value="1" id="input-canMix" checked="checked" />
                      <?php } else { ?>
                        <input type="checkbox" name="canMix" value="1" id="input-canMix" />
                      <?php } ?>
                    </label>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tax-limit"><span data-toggle="tooltip" title="<?php echo $help_tax_limit; ?>"><?php echo $entry_tax_limit; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="tax_limit" value="<?php echo $tax_limit; ?>" placeholder="<?php echo $entry_tax_limit; ?>" id="input-tax-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tax-type"><?php echo $entry_tax_type; ?></label>
                <div class="col-sm-10">
                  <select name="tax_type" id="input-tax-type" class="form-control">
                    <?php if ($tax_type) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-weight-limit"><?php echo $entry_weight_limit; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="weight_limit" value="<?php echo $weight_limit; ?>" placeholder="<?php echo $entry_weight_limit; ?>" id="input-weight-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-limit"><?php echo $entry_quantity_limit; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_limit" value="<?php echo $quantity_limit; ?>" placeholder="<?php echo $entry_quantity_limit; ?>" id="input-quantity-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-violation-fee"><span data-toggle="tooltip" title="<?php echo $help_violation_fee; ?>"><?php echo $entry_violation_fee; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="violation_fee" value="<?php echo $violation_fee; ?>" placeholder="<?php echo $entry_violation_fee; ?>" id="input-violation-fee" class="form-control" />
                </div>
              </div>
            </div>
