 <div id="tab-watermark">
    <table class="table">
        ...
        <td class="col-xs-3">
            ...
            <span class="help"><i class="fa fa-info-circle"></i>&nbsp;Enable or disable WaterMark for the selected store.</span>
        </td>
        <td class="col-xs-9">
            <div class="col-xs-4">
        ...
        <tr class="iWatermarkActiveTR">
            <td class="col-xs-3">
                ...
                <span class="help"><i class="fa fa-info-circle"></i>&nbsp;If you wish to compare the images to only one dimension, leave the other box empty. (e.g. 100x0 or 100x&#39;&#39;)</span>
            </td>
            <td class="col-xs-9">
            	<div class="col-xs-4">
        ...
        <tr class="iWatermarkActiveTR iWatermarkImageTR">
            <td class="col-xs-3">
                ...
                <span class="help"><i class="fa fa-info-circle"></i>&nbsp;The watermark image (.png; .jpg)</span>
            </td>
            <td class="col-xs-9">
                <div class="col-xs-4">
        ...
        <tr class="iWatermarkActiveTR iWatermarkTextTR">
            <td class="col-xs-3">
                ...
                <span class="help"><i class="fa fa-info-circle"></i>&nbsp;You can upload your own custom fonts in /vendors/iwatermark/font/. They need to have the .ttf extension.</span>
            </td>
            <td class="col-xs-9">
                <div class="col-xs-4">
        ...
        <tr class="iWatermarkActiveTR">
            <td class="col-xs-3">
                ...
                <span class="help"><i class="fa fa-info-circle"></i>&nbsp;Where on the image should the watermark be applied.</span>
            </td>
            <td class="col-xs-9">
                <div class="col-xs-4">
                    <select name="iwatermark[Position]" class="form-control">
                        ...
                        <option value="top_center" <?php echo !empty($data['iwatermark']['Position']) && $data['iwatermark']['Position'] == 'top_center' ? 'selected=selected' : ''?>><?php echo $text_top_center; ?></option>
                        ...
                        <option value="left_center" <?php echo !empty($data['iwatermark']['Position']) && $data['iwatermark']['Position'] == 'left_center' ? 'selected=selected' : ''?>><?php echo $text_left_center; ?></option>
                        ...
                        <option value="right_center" <?php echo !empty($data['iwatermark']['Position']) && $data['iwatermark']['Position'] == 'right_center' ? 'selected=selected' : ''?>><?php echo $text_right_center; ?></option>
                        ...
                        <option value="bottom_center" <?php echo !empty($data['iwatermark']['Position']) && $data['iwatermark']['Position'] == 'bottom_center' ? 'selected=selected' : ''?>><?php echo $text_bottom_center; ?></option>
        ...
        <tr class="iWatermarkActiveTR iWatermarkImageTR">
            <td class="col-xs-3">
                ...
                <span class="help"><i class="fa fa-info-circle"></i>&nbsp;If the watermark is a transparent .png image, it will look better with this option checked.</span>
            </td>
            <td class="col-xs-9">
                <div class="col-xs-4">
        ...
        <tr class="iWatermarkActiveTR iWatermarkOpacityTR">
            <td class="col-xs-3">
                ...
                <span class="help"><i class="fa fa-info-circle"></i>&nbsp;Opacity of the watermark (0-100). Default is 70.</span>
            </td>
            <td>
                <div class="col-xs-4">
                    <div class="input-group">
...
$(document).ready(function() {
        ...
        $('input[name=\'category\']').autocomplete({
            'source': function(request, response) {
                $.ajax({
                    url: 'index.php?route=<?php echo $module_path ?>/autocomplete_category&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
                    dataType: 'json',           
        ...
        $('input[name=\'related\']').autocomplete({
            'source': function(request, response) {
                $.ajax({
                    url: 'index.php?route=<?php echo $module_path ?>/autocomplete_product&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
                    dataType: 'json',           
                    success: function(json) {
                        response($.map(json, function(item) {
                            return {
