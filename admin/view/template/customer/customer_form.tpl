                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-chinaid<?php echo $address_row; ?>"><?php echo $entry_chinaid; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][chinaid]" value="<?php echo $address['chinaid']; ?>" placeholder="<?php echo $entry_chinaid; ?>" id="input-chinaid<?php echo $address_row; ?>" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-chinaid-images<?php echo $address_row; ?>"><?php echo $entry_chinaid_images; ?></label>
                        <div class="col-sm-10">
                        <?php if (!empty($address['chinaid_front'])) { ?><img src='<?php echo $address['chinaid_front']; ?>'><?php } ?>
                        <?php if (!empty($address['chinaid_back'])) { ?><img src='<?php echo $address['chinaid_back']; ?>'><?php } ?>
                        </div>
                      </div>
                      <?php foreach ($custom_fields as $custom_field) { ?>
