...
<div class="container">
	...
	<h3><a href="/upload_format/AME_product_format.xlsx" style="text-decoration: underline;">上传格式：AME_product_format.xlsx</a></h3>
    ...
    <form id='uploadform' action='<?php echo $action_url; ?>' method='POST'  enctype="multipart/form-data">
		...
		<div class="row" style="margin-top: 10px;">
			...
			<div class="col-sm-2"><input type='radio' value='add' name="upload_type" checked> 仅添加新数据</div>
			<div class="col-sm-2"><input type='radio' value='cover' name="upload_type"> 覆盖已有数据</div>
		</div>
	    <div class="row" style="margin-top: 10px;">
	...
	<div class="row" style="margin-top: 20px;">
		<div class="col-xs-12">
			...
			<h1>格式中的“品牌”字段无效，品牌需要在后台的“品牌管理”自行添加</h1>
		</div>
	</div>
</div>
<script>
