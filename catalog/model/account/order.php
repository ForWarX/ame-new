...
class ModelAccountOrder extends Model {
	public function getOrder($order_id, $order_no=null) {
	    if ($order_no == null) {
            ...
            $order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE invoice_prefix = '" . $order_no . "' AND customer_id = '" . (int)$this->customer->getId() . "' AND order_status_id > '0'");
        }
	...
	//Track order
	public function getTrackOrder($prefix) {
		...
		if ($order_query->num_rows) {
			...
			$order_product_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_product WHERE order_id = '" .$order_query->row['order_id'] . "'");
