...
class ControllerInformationTracking extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('information/tracking/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('information/tracking', $url)
		);
		...
		$data['action'] = $this->url->link('information/tracking', '', true);
		...
		$data['headering'] = $this->load->controller('common/headering');
		//新增 TRACK 信息
...
//添加AME号
	...
	public function success() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('information/tracking')
		);
