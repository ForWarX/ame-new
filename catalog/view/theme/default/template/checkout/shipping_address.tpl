<form class="form-horizontal">
  ...
  <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    <div class="form-group required">
      <label class="col-sm-2 control-label" for="input-shipping-firstname"><?php echo $entry_name; ?></label>
        <div class="col-sm-10">
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_name; ?>" id="input-shipping-firstname" class="form-control" />
      </div>
    </div>
    <!--
    <div class="form-group required">
    ...
    <div class="form-group" id="china_id">
      ...
      <div class="col-sm-10">
        <input type="text" name="chinaid" placeholder="<?php echo $entry_china_id; ?>" id="input-shipping-id" class="form-control" />
      </div>
    </div>
    <div class="form-group" id="china_id_front">
      ...
      <div class="col-sm-10">
        <input type="file" name="chinaid_front" placeholder="<?php echo $entry_china_id_front; ?>" id="input-shipping-id_font" class="form-control" />
      </div>
    </div>
    <div class="form-group" id="china_id_back">
      ...
      <div class="col-sm-10">
        <input type="file" name="chinaid_back" placeholder="<?php echo $entry_china_id_back; ?>" id="input-shipping-id_back" class="form-control" />
      </div>
    </div>
...
<script>
  /**
   * Delivery shipping address: China
   */
  if ($("#input-shipping-country").val() === 44) {
      $('#china_id').show();
      $('#china_id_front').show();
      $('#china_id_back').show();
  }
  ...
  $('#input-shipping-country').change(function(e) {
      if ($('#input-shipping-country').val() == 44) {
          $('#china_id').show();
          $('#china_id_front').show();
          $('#china_id_back').show();
