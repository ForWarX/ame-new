...
class ControllerCheckoutConfirm extends Controller {
	public function index() {
		...
		if (!$redirect) {
			...
			$data['text_final_weight'] = $this->language->get('text_final_weight');
			$data['text_final_price'] = $this->language->get('text_final_price');
			$data['text_final_category'] = $this->language->get('text_final_category');
			$data['text_admin_func'] = $this->language->get('text_admin_func');
