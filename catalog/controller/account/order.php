...
// add filter data
		...
		//$results = $this->model_account_order->getOrders(($page - 1) * 10, 10, null);
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['order_copy'] = $this->url->link('product/apply/copy', "order_id=" . $order_id, true); // 复制当前订单内容去下新单的链接
			...
			$data['order_no'] = $order_info['invoice_prefix'];
